defmodule LmsApi.Catalog do
  ...
  alias LmsApi.Catalog.{Course, CourseSyllabus, CourseModule, ModuleLesson}
  ...
  """
  def reorder_module_lessons(module_id, lesson_ids) do
  ...
  """
  def reorder_course_modules(course_id, module_ids) do
