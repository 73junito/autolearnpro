...
This repository includes a convenience script to generate PNG thumbnails for the static site; images are now stored under `theme/assets/images/docs`.
...
Script
- `docs/site/scripts/generate-sd-thumbnails.ps1` (writes to `theme/assets/images/docs` by default)
...
Notes and tips
- Output files (default): `theme/assets/images/docs/course-1.png`, `course-2.png`, `course-3.png`.
