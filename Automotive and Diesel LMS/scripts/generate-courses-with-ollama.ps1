...
$courses = @(
  @{ key='course-intro-to-diesel-engines'; title='Introduction to Diesel Engines'; thumbnail='../../../theme/assets/images/docs/course-1.png'; level='Beginner'; lessons=6; modules=@('Engine Fundamentals','Fuel Systems','Ignition & Compression','Cooling & Lubrication','Diagnostics & Tools','Maintenance Best Practices') },
  @{ key='advanced-engine-diagnostics'; title='Advanced Engine Diagnostics'; thumbnail='../../../theme/assets/images/docs/course-2.png'; level='Intermediate'; lessons=8; modules=@('Sensor Basics','Fault Code Interpretation','Oscilloscope Techniques','CAN Bus Basics','Practical Diagnostic Labs') },
  @{ key='fuel-systems-injection'; title='Fuel Systems & Injection'; thumbnail='../../../theme/assets/images/docs/course-3.png'; level='Advanced'; lessons=10; modules=@('Fuel Pump Types','Injection Principles','Pressure & Flow Testing','Calibration Methods','Troubleshooting Common Failures') }
)
